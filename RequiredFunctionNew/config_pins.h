...
#define FRONT_LEFT_EN_B 31

#define FRONT_RIGHT_PWM 8
#define FRONT_RIGHT_BACKWARD 36
#define FRONT_RIGHT_FORWARD 37
#define FRONT_RIGHT_EN_A 19
#define FRONT_RIGHT_EN_B 38

#define BACK_LEFT_PWM 9
#define BACK_LEFT_BACKWARD 43
#define BACK_LEFT_FORWARD 42
#define BACK_LEFT_EN_A 3
#define BACK_LEFT_EN_B 49

#define BACK_RIGHT_PWM 5
#define BACK_RIGHT_BACKWARD A5
#define BACK_RIGHT_FORWARD A4
#define BACK_RIGHT_EN_A 2
#define BACK_RIGHT_EN_B A1
